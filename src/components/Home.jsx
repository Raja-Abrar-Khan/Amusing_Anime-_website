              ...
              return (
                ...
                >
                  <img
                    ...
                    alt={top.images.jpg.image_url}
                  />
                  <div className="p-3 card-content">
                    <h2 className="text-2xl font-bold mb-2"> {top.title} </h2>
                    <p className="text-gray-700">{top.title_japanese}</p>
                    <p className="text-gray-700">{top.rating}</p>
                    <p className="text-gray-700">{top.duration}</p>
                    {/* <p className="text-gray-700">{list.synopsis.substr(0, 100)}</p> */}
                  </div>
                </div>
              );
            })
